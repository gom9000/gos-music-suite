...
The projects collected here range from bare-metal firmware designed to make vintage hardware sing, to custom-built boxes for the stage. Alongside completed instruments ready for the gig, there are transcriptions in progress and rough sketches of MIDI messages.
